...
/* cv-mac Debug Console output channel — used by RedAlert below to
 ...
 * is the #256 case — stub Rez fork). System header, no per-project
 * bundling. */
#include <cvm_log.h>
